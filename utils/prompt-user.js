...
async function getStarterQuestion() {
  ...
  return {
    type: 'list',
    message:
      'Which starter would you like to use? (Starters are fullstack Siapi applications designed for a specific use case)',
...
async function getStarterData() {
  const response = await fetch(
    `https://api.github.com/repos/siapi/community-content/contents/starters/starters.yml`
  );
